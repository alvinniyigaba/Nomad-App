...
// history for the app to look lived-in. Safe to re-run: it wipes and
// recreates every table it touches (this is a pilot fixture, not a
// migration — never point this at data you care about).
...
try {
  ...
  // Fixture reset — this script owns these tables entirely.
